...
public class LoginRegisterUtils {
    ...
    public static boolean userAvailable(String userId, Context context) {
        if (userId.isEmpty()) {
...
//        }
     ...
     * @param context
     */
    public static boolean passwordSame(String password1, String password2,Context context) {
        if (password1.isEmpty() || password2.isEmpty()) {
            Toast.makeText(context, "请输入密码", Toast.LENGTH_SHORT).show();
            return false;
        }
        if (!password1.equals(password2)) {
            Toast.makeText(context, "两次密码不相等", Toast.LENGTH_SHORT).show();
            return false;
        }
        //密码相等
        return true;
...
//     * @param context   上下文
//     */
//    public static boolean passwordCorrected(String userId, String password,Context context) {
//        if (password.isEmpty()) {
